(function($) {
	 ...
	 */
	var wvnFBAddToCartHandler = function() {
		$(document.body)
	 ...
	 */
	wvnFBAddToCartHandler.prototype.onAddToCart = function(e) {
		e.preventDefault();
	 ...
	 */
	wvnFBAddToCartHandler.prototype.updateButton = function(e, fragments, cart_hash, $button) {
	...
	/**
	 * Init wvnFBAddToCartHandler.
	 */
	new wvnFBAddToCartHandler();
})(jQuery);