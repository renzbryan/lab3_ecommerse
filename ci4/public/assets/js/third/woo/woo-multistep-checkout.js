        ...
        timeline.find( '.active' ).removeClass( 'active' );
            ...
            if ( action == 'next' ) {
                ...
                if ( 0 === inputField.filter(function() {
                    ...
                    $j( checkout_form ).find( '.woovina-multistep-error-notice' ).remove();
                    ...
                    if ( 0 === $j( checkout_form ).find( '.woovina-multistep-error-notice' ).length ) {
                        $j( checkout_form ).prepend( '<div class="woovina-multistep-error-notice"><ul class="woocommerce-error" role="alert"></ul></div>' );
                        $j( '.woovina-multistep-error-notice' ).html( '<ul class="woocommerce-error" role="alert">' );
                        $j( '.woocommerce-error' ).prepend( '<li >' + woovinaLocalize.multistep_checkout_error + '</li>' );
                    }
