...
// Start and run class.
if ( ! class_exists( 'WooVina_Gutenberg_Editor' ) ) {

	/**
	 * WooVina Gutenberg Class
	 */
	class WooVina_Gutenberg_Editor {
		...
		public function elements() {
			...
			return apply_filters(
				'woovina_gutenberg_typography_tags',
				array(
					'body'            => array(
		...
		public function loop( $return = 'css' ) {
			...
			if ( ! empty( $elements ) ) {
				...
				if ( 'css' === $return && ! empty( $css ) ) {
					$css = '/* WooVina Gutenberg Style */' . $css;
					return $css;
				}
		...
		public function gutenberg_editor_style( $output ) {
			...
			if ( ! is_null( get_current_screen() ) && get_current_screen()->is_block_editor() ) {
				...
				$primary_color     = get_theme_mod( 'woovina_primary_color', '#13aff0' );
				$links_color       = get_theme_mod( 'woovina_links_color', '#333333' );
				$links_color_hover = get_theme_mod( 'woovina_links_color_hover', '#13aff0' );
				...
				$heading_tag = get_theme_mod( 'woovina_single_post_heading_tag', 'h2' );
				...
				$background_layout           = get_theme_mod( 'woovina_main_layout_style', 'wide' );
				$background_color            = get_theme_mod( 'woovina_background_color', '#ffffff' );
				$boxed_separate_bg_color     = get_theme_mod( 'woovina_boxed_inner_bg', '#ffffff' );
...
return new WooVina_Gutenberg_Editor();
