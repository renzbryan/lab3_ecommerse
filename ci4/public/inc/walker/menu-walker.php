		...
		public function display_element($element, &$children_elements, $max_depth, $depth=0, $args = array(), &$output) {
			...
			if(! empty($children_elements[$element->$id_field]) && ($depth == 0)
				...
				if(true == get_theme_mod('woovina_menu_arrow_down', true)) {					
					('full_screen' == $header_style) ? $element->title .= '' . $full_screen_dropdown : $element->title .= ' <span class="nav-arrow fa fa-angle-down"></span>';
				}
			}
			...
			if(! empty($children_elements[$element->$id_field]) && ($depth > 0)) {
				...
				if(true == get_theme_mod('woovina_menu_arrow_side', true)) {
					if(is_rtl()) {						
						('full_screen' == $header_style) ? $element->title .= $full_screen_dropdown : $element->title .= '<span class="nav-arrow fa fa-angle-left"></span>';
					} else {						
						('full_screen' == $header_style) ? $element->title .= $full_screen_dropdown : $element->title .= '<span class="nav-arrow fa fa-angle-right"></span>';
					}
				}
			}
